...
The _**lm()**_ analysis also gave as an estimation of that difference. _**Mpg**_ for the cars with manual transmission is greater on **`r tr_dif`** than for the cars with automatic transmission.
